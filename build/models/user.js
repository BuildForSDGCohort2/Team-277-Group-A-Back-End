...
module.exports = (sequelize, DataTypes) => {
  ...
  User.prototype.comparePassword = (password, user) => _bcrypt.default.compareSync(password, user.password);
  /**
  ...
  User.prototype.encryptPassword = password => _bcrypt.default.hashSync(password, _bcrypt.default.genSaltSync(6));
